...
public class EditCommand extends Command {
    ...
    private static Task createEditedTask(ReadOnlyTask taskToEdit,
        ...
        TaskType updatedType = editTaskDescriptor.getType().orElse(taskToEdit.getTaskType());
        DueDate updatedDate = editTaskDescriptor.getDate().orElse(taskToEdit.getDate());
        Set<Tag> updatedTags = editTaskDescriptor.getTags().orElse(taskToEdit.getTags());

        return new Task(updatedName, updatedTime, updatedType, updatedDate, updatedTags);
    }
    ...
    public static class EditTaskDescriptor {
        ...
        public Optional<TaskType> getType() {
