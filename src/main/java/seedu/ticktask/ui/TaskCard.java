...
public class TaskCard extends UiPart<Region> {
    ...
    //@@author A0139964M
    /**
     * Initialize the estimated start time of the Event
     * Sets colour and text respectively based on whether if it is 1)Happening 2)Over Due 3)Approaching date
     */
    ...
    /**
     * Initialize the estimated start time of the Deadline
     * Sets colour and text respectively based on whether if it is 1)approaching date 2)Over Due
     */
