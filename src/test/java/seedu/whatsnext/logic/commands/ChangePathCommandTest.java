...
/*    @Test
    ...
    public void execute_noSaveLocation_success() {
        ...
        assertNoSaveLocationSuccess(String.format(MESSAGE_INVALID_COMMAND_FORMAT, ChangePathCommand.MESSAGE_USAGE), OUTPUT);
    }*/
    //@@author A0149894H
    @Test 
    public void execute_properSaveLocation_success() throws RepeatTaskManagerFilePathException, CommandException {
        ...
        assertProperSaveLocationSuccess(config, file);
     ...
     */
    private void assertProperSaveLocationSuccess(Config config, File file) throws CommandException{
