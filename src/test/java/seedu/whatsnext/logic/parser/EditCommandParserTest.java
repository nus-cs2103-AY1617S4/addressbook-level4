...
public class EditCommandParserTest {
    ...
    public void parse_someFieldsSpecified_success() throws Exception {
        ...
        EditTaskDescriptor descriptor = new EditTaskDescriptorBuilder().withPhone(VALID_DATE_BOB)
    ...
    public void parse_oneFieldSpecified_success() throws Exception {
        ...
        descriptor = new EditTaskDescriptorBuilder().withPhone(VALID_DATE_AMY).build();
    ...
    public void parse_invalidValueFollowedByValidValue_success() throws Exception {
        ...
        EditTaskDescriptor descriptor = new EditTaskDescriptorBuilder().withPhone(VALID_DATE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(userInput, expectedCommand);
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_DATE_DESC + ADDRESS_DESC_BOB
                + DATE_DESC_BOB;
        descriptor = new EditTaskDescriptorBuilder().withPhone(VALID_DATE_BOB).withEmail(VALID_EMAIL_BOB)
