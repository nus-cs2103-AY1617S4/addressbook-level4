...
public class TestApp extends MainApp {
    ...
    protected static final String TICKTASK_PROGRAM_NAME = "Test";
    protected Supplier<ReadOnlyTickTask> initialDataSupplier = () -> null;
    protected String saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyTickTask> initialDataSupplier, String saveFileLocation) {
        super();
    ...
    protected UserPrefs initPrefs(UserPrefsStorage storage) {
        ...
        userPrefs.setTickTaskFilePath(saveFileLocation);
        userPrefs.setTickTaskName(TICKTASK_PROGRAM_NAME);
        return userPrefs;
    }
