...
public class StringUtilTest {
    ...
    private void assertExceptionThrown(Class<? extends Throwable> exceptionClass, String sentence, String word,
        ...
        StringUtil.containsStringIgnoreCase(sentence, word);
    }
    ...
    public void containsWordIgnoreCase_validInputs_correctResult() {
        ...
        assertFalse(StringUtil.containsStringIgnoreCase("aaa bbb ccc", "bb")); // Sentence word bigger than query word
        assertFalse(StringUtil.containsStringIgnoreCase("aaa bbb ccc", "bbbb")); // Query word bigger than sentence word

        // Matches word in the sentence, different upper/lower case letters
        assertTrue(StringUtil.containsStringIgnoreCase("aaa bBb ccc", "Bbb")); // First word (boundary case)
        assertTrue(StringUtil.containsStringIgnoreCase("aaa bBb ccc@1", "CCc@1")); // Last word (boundary case)
        assertTrue(StringUtil.containsStringIgnoreCase("  AAA   bBb   ccc  ", "aaa")); // Sentence has extra spaces
        ...
        assertTrue(StringUtil.containsStringIgnoreCase("AAA bBb ccc  bbb", "bbB"));
    }
