...
public class EventListPanelHandle extends GuiHandle {
    ...
    private static final String DEADLINE_TASK_LIST_VIEW_ID = "#eventListView";
    ...
    public ListView<Pair<BasicTaskFeatures, Integer>> getEventListView() {
        ListView<Pair<BasicTaskFeatures, Integer>> eventListView = getNode(DEADLINE_TASK_LIST_VIEW_ID);
